...
class Bureaucrat
{
	public:
		...
		void signForm(AForm& form) const; // attempts to sign a form, prints outcome
		void executeForm(const AForm& form) const; // attempts to execute a form, prints outcome
